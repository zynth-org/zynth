...
*   `packages/`
    ...
    *   `rune-router`: Cross-platform native router implementation.
...
*   **Router Debugging:**
    *   **iOS:** `packages/rune-router/ios/RuneRouter/RNStackController.swift` manages the navigation stack.
    *   **Android:** `packages/rune-android-router/android` manages Fragments/Activities.
    *   **JS:** `packages/rune-router/src` contains the SolidJS context and actions.
