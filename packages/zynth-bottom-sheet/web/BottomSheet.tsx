...
if (
  ...
  !document.getElementById("zynth-bottom-sheet-styles")
) {
  const style = document.createElement("style");
  style.id = "zynth-bottom-sheet-styles";
  style.textContent = `
    .zynth-bottom-sheet-overlay {
      position: absolute;
      inset: 0;
    ...
    .zynth-bottom-sheet-overlay[data-open="true"] {
      opacity: 0.45;
      pointer-events: auto;
    }

    .zynth-bottom-sheet-container {
      position: absolute;
      left: 0;
      right: 0;
      bottom: 0;
    ...
    .zynth-bottom-sheet-content[data-open="true"] {
      transform: translateY(0);
    }

    .zynth-bottom-sheet-handle {
      width: 40px;
      height: 4px;
...
export const BottomSheet: ParentComponent<any> = (props) => {
  ...
  return (
    ...
    >
      <div
        class="zynth-bottom-sheet-overlay"
        style={overlayStyle()}
        onClick={handleOverlayClick}
      />
      <div class="zynth-bottom-sheet-container">
        <div
          class="zynth-bottom-sheet-content"
          style={contentStyle()}
          data-open={isOpen() ? "true" : "false"}
        >
          <div class="zynth-bottom-sheet-handle" />
...
registerComponent("zynth-bottom-sheet", BottomSheet);
