    ...
    fun fromJson(jsonString: String): Style {
      try {
        ...
        return Style(
          ...
          borderRightColor = json.optString("borderRightColor")?.let { parseColor(it) },
          borderBottomColor = json.optString("borderBottomColor")?.let { parseColor(it) },
          borderLeftColor = json.optString("borderLeftColor")?.let { parseColor(it) },
