...
async function runBuildNow({
  ...
  const artifactsMountPath =
    process.env.SKYHOOK_BUILD_ARTIFACTS_MOUNT ?? "/opt/zynth-artifacts";
  ...
  const createOptions = {
    ...
    Labels: {
      "zynth.skyhook": "true",
      "zynth.skyhook.role": "build",
      "zynth.skyhook.run_id": runId,
      "zynth.skyhook.app_id": appId,
    },
  };
