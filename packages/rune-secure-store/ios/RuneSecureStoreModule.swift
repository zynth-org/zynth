...
@objc(RuneSecureStoreModule)
final class RuneSecureStoreModule: NSObject, RuneModule, RuneSyncModule {
  let name: String = "RuneSecureStore"
...
private struct SecureStoreOptions {
  ...
  var service: String {
    ...
    return Bundle.main.bundleIdentifier ?? "dev.rune.securestore"
  }
