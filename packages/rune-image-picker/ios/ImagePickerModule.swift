...
public class ImagePickerModule: NSObject, RuneModule {
    public var name: String { "ImagePicker" }
    private let runtime: RuneRuntime
    private var pendingRequestId: String?
    
    public init(runtime: RuneRuntime) {
    ...
    public func call(method: String, args: Any?) throws -> Any? {
        ...
        default:
            throw RuneModuleError.moduleNotFound("Method \(method) not found in ImagePicker module")
        }
    }
