...
A high-performance, native bottom sheet component for Rune.
...
```tsx
import { BottomSheet, View, Text } from "@rune/bottom-sheet";
...
```tsx
import { BottomSheet, createBottomSheetController, Button } from "@rune/bottom-sheet";
