...
final class ZynthModalContentViewController: UIViewController {
  ...
  init(contentHost: UIView, options: ZynthModalOptions) {
  ...
  func applyOptions(_ newOptions: ZynthModalOptions) {
    options = newOptions
