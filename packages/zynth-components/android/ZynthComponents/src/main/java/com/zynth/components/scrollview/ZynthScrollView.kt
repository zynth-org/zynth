...
internal class ZynthScrollView(
  context: Context,
) : FrameLayout(context) {
  ...
  private var manager: com.zynth.kit.core.ZynthUIManager? = null
  ...
  private inner class ZynthVerticalScrollHost(context: Context) :
    ...
    override fun onInterceptTouchEvent(ev: MotionEvent): Boolean {
      ...
      if (!this@ZynthScrollView.scrollEnabled) return false
    ...
    override fun ensureContentAttached(content: View) {
      ...
      if (isNativeDebugEnabled()) {
        Log.d("ZynthScrollView", "ensureContentAttached vertical contentH=${content.height}")
      }
  ...
  private inner class ZynthHorizontalScrollHost(context: Context) :
