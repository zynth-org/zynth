...
class ZynthDatePickerView(context: Context) : FrameLayout(context) {
  ...
  private var triggerView: ZynthDatePickerTriggerView? = null
  ...
  override fun onViewAdded(child: View) {
    ...
    if (child is ZynthDatePickerTriggerView) {
      attachTrigger(child)
    }
  }
  ...
  fun showPicker() {
    ...
    val tag = "zynth_date_picker_$nodeId"
  ...
  private fun attachTrigger(trigger: ZynthDatePickerTriggerView) {
