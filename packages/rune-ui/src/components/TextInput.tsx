import { TextInput as NativeTextInput, type TextInputProps as NativeTextInputProps, View, Text } from "@rune/components";
...
export const TextInput: ParentComponent<TextInputProps> = (props) => {
  ...
  const resolvedStyle = () => {
    ...
    switch (tone) {
      case "danger": borderColor = t.colors.danger; break;
      case "success": borderColor = t.colors.success; break;
      case "warning": borderColor = t.colors.warning; break;
      case "default": 
      default: 
      ...
      {local.label && (
        <Text 
          style={{ 
            ...
            color: local.error ? theme().colors.danger : theme().colors.textMuted,
