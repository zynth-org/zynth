...
A lightweight, native HTTP server for Rune apps.

This package allows your Rune application to serve static content or handle file uploads directly from the device. It is useful for building local file sharing tools, custom dev servers, or offline-first interfaces.
...
```tsx
import { WebServer, Paths } from "@rune/webserver";
