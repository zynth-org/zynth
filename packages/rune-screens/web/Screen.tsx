...
if (typeof document !== "undefined" && !document.getElementById("rune-screen-animations")) {
  const style = document.createElement("style");
  style.id = "rune-screen-animations";
  style.textContent = `
    .rune-screen {
      position: absolute;
      inset: 0;
    ...
    .rune-screen[data-anim="push"] { transform: translate3d(100%, 0, 0); opacity: 1; }
    .rune-screen[data-anim="modal"] { transform: translate3d(0, 100%, 0); opacity: 1; }
    .rune-screen[data-anim="fade"] { transform: none; opacity: 0; }
    .rune-screen[data-anim="zoom"] { transform: scale(0.9); opacity: 0; }
    .rune-screen[data-anim="none"] { transform: none; opacity: 1; }
    ...
    .rune-screen[data-active="true"][data-covered="true"] {
    ...
    .rune-screen[data-active="true"][data-covered="true"]::after {
      content: '';
      position: absolute;
      inset: 0;
      background: black;
    ...
    .rune-screen[data-active="true"][data-covered="false"]::after {
      content: '';
      position: absolute;
      inset: 0;
      background: black;
...
registerWebComponent("rune-screen", {
  create: () => {
    const el = document.createElement("div");
    el.classList.add("rune-screen");
    ...
    el.addEventListener("transitionend", (e) => {
      ...
      const props = (el as any).__rune_props;
