...
@objcMembers
public final class RuneScreenSheetContainerView: UIView, RuneScreenContainer {
  ...
  private func controller(for screen: RuneScreenView) -> RuneScreenViewController {
  ...
  private func updateLayout() {
    ...
    var animationType: RuneScreenAnimation = .push
  ...
  private func transition(from fromVC: RuneScreenViewController?, to toVC: RuneScreenViewController?, operation: UINavigationController.Operation, animationType: RuneScreenAnimation) {
    guard let parentVC = parentViewController else { return }
