...
class ZynthKeyboardStickyView(context: Context) : FrameLayout(context) {
            ...
            ViewCompat.setWindowInsetsAnimationCallback(
                ...
                object : WindowInsetsAnimationCompat.Callback(DISPATCH_MODE_CONTINUE_ON_SUBTREE) {
                    ...
                    override fun onEnd(animation: WindowInsetsAnimationCompat) {
                        ...
                        val insets = ViewCompat.getRootWindowInsets(this@ZynthKeyboardStickyView) ?: return
                        val imeInsets = insets.getInsets(WindowInsetsCompat.Type.ime())
                        val imeHeight = imeInsets.bottom / density
                        val isVisible = insets.isVisible(WindowInsetsCompat.Type.ime())
    ...
    private fun findAvoidingParentPadding(): Float {
        ...
        while (currentParent != null) {
            ...
            if (currentView is ZynthKeyboardAvoidingView) {
