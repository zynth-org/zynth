...
import com.zynth.kit.core.ZynthGradientParser
import com.zynth.kit.core.ZynthLinearGradient
import com.zynth.kit.core.ZynthShadowParser
...
data class Style(
  ...
  val backgroundGradient: ZynthLinearGradient? = null,
  ...
  companion object {
    ...
    fun fromJson(jsonString: String): Style {
      try {
        ...
        val backgroundGradient = ZynthGradientParser.parse(backgroundValue)
        ...
        return Style(
          ...
          boxShadow = ZynthShadowParser.merge(
            ZynthShadowParser.parse(json.opt("boxShadow")),
          ...
          transform = ZynthTransformParser.parse(json.opt("transform")),
    ...
    /**
     * Parse color from various formats using ZynthColorParser.
     */
