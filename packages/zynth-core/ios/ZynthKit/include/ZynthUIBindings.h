...
void ZynthUIInvokePressEvent(int nodeId,
                             ...
                             double timestampMs,
                             bool cancelled);
void ZynthUIInvokePressEventWithRuntime(void * _Nullable runtimePtr,
                                        int nodeId,
                                        const char *name,
                                        double x,
                                        double y,
                                        ...
                                        double timestampMs,
                                        bool cancelled);
void ZynthUIInvokeEventWithRuntime(void * _Nullable runtimePtr,
                                   int nodeId,
                                   const char *name,
                                   NSDictionary *payload);
void ZynthUIInvokeLayoutEventWithRuntime(void * _Nullable runtimePtr,
                                         int nodeId,
                                         double x,
                                         double y,
                                         double width,
