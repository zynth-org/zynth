...
private let dimensionsEventName = "rune.dimensions.change"
...
final class RuneDimensionsModule: NSObject, RuneModule, RuneSyncModule {
  ...
  init(runtime: RuneRuntime, rootView: UIView) {
