...
final class ZynthScreenViewController: UIViewController {
  let screenView: ZynthScreenView
  private var rightAccessoryHost: ZynthScreenHeaderAccessoryHostView?
  ...
  init(screenView: ZynthScreenView) {
  ...
  private func makeHeaderAppearance(using options: ZynthScreenHeaderOptions) -> UINavigationBarAppearance {
  ...
  private func applyHeaderTint(using options: ZynthScreenHeaderOptions) {
    if options.headerStyle == .liquidGlass {
  ...
  private func updateBackItems(using options: ZynthScreenHeaderOptions) {
  ...
  private func makeRightBarButton(from options: ZynthScreenHeaderButtonOptions) -> UIBarButtonItem {
