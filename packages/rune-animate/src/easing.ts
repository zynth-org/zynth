...
type NamedEasingFunction = EasingFunction & { __runeEasingName?: EasingName };
...
const markEasing = (fn: EasingFunction, name: EasingName): NamedEasingFunction => {
  (fn as NamedEasingFunction).__runeEasingName = name;
...
export const resolveEasingName = (
  ...
  return named.__runeEasingName ?? "easeOutCubic";
};
