...
High-performance, declarative animations for Rune.
...
```tsx
import { Animated, useSharedValue, useAnimatedStyle, withSpring } from "@rune/animate";
import { Button } from "@rune/components";
...
```tsx
import { Animated, FadeIn, FadeOut } from "@rune/animate";
...
```tsx
import { Animated, LinearTransition } from "@rune/animate";
