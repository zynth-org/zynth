...
function loadRuneAliases() {
  ...
  try {
    ...
    if (existsSync(coreUniversalSrc)) {
      aliases["@rune/core/universal"] = coreUniversalSrc;
    } else if (existsSync(coreUniversalSource)) {
      aliases["@rune/core/universal"] = coreUniversalSource;
    }
  } catch {
...
const extraAliases = loadRuneAliases();
