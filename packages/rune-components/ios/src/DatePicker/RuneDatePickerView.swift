...
@objcMembers
public final class RuneDatePickerView: UIView {
  private weak var manager: SNUIManager?
  private weak var node: SNNode?
  private weak var activeController: RuneDatePickerModalController?
  ...
  public func show() {
    ...
    let controller = RuneDatePickerModalController(
      mode: mode,
      titleText: titleText,
...
private final class RuneDatePickerModalController: UIViewController, UIAdaptivePresentationControllerDelegate {
  let mode: String
