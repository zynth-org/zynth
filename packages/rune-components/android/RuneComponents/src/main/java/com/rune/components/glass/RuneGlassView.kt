 ...
 */
class RuneGlassView(context: Context) : RuneViewContainer(context) {
    ...
    override fun onTouchEvent(event: MotionEvent): Boolean {
        ...
        if (pointerMode == com.rune.components.view.RuneViewContainer.PointerEventsMode.NONE || 
            pointerMode == com.rune.components.view.RuneViewContainer.PointerEventsMode.BOX_NONE) {
            return false
        }
