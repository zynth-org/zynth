...
class RuneAsyncStorageModule(
    context: Context
) : RuneModule, RuneSyncModule {
    override val name: String = "RuneAsyncStorage"
    private val storage = RuneAsyncStorageStore(context)
...
private class RuneAsyncStorageStore(context: Context) {
    private val prefs: SharedPreferences =
        context.getSharedPreferences("rune_async_storage", Context.MODE_PRIVATE)
