...
Run multiple isolated Zynth applications within a single host.

The Hypervisor allows you to embed a secondary Zynth runtime inside a view. This is ideal for:
...
*   **Isolation**: Each Hypervisor view runs in its own `ZynthRuntime` instance with a separate JS VM context.
